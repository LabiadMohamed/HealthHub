...
CREATE TABLE `email_subscriptions` (
  ...
  CONSTRAINT `email_subscriptions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `email_subscriptions` VALUES (1,2,'amin@gmail.com',0,'2026-05-20 12:28:01');
