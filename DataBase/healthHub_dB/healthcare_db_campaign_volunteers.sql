...
CREATE TABLE `campaign_volunteers` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `campaign_volunteers_ibfk_1` FOREIGN KEY (`campaign_id`) REFERENCES `campaigns` (`id`) ON DELETE CASCADE,
  CONSTRAINT `campaign_volunteers_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
